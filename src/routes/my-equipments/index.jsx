              ...
              ({
                ...
                <div key={_id} className="card card-bordered mx-auto w-full rounded-2xl shadow-xl">
                  ...
                  <div className="card-body">
                    ...
                    <div className="flex justify-between items-center text-sm md:text-base text-base-content/70">
                      <div>
                        {processingTime} <span className="text-base-content/50">to process</span>
                      </div>
                      <div>
                        {stockStatus} <span className="text-base-content/50">in stock</span>
                      </div>
                    </div>
